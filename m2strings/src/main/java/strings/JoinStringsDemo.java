...
public class JoinStringsDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(joinOldWay(delimeter, strings));
        System.out.println(joinSimplest(delimeter, strings));
        System.out.println(joinWithJoiner(delimeter, strings));
        System.out.println(joinWithStream(delimeter, strings));
    }
